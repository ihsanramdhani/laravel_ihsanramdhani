...
<body>
  <div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">Update Patient Data</div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('patient.update', ['id' => $data->id]) }}">
                            @csrf
                            @method("PUT")
                            ...
                            <div class="form-group">
                                ...
                                <input id="hospital_id" type="text" class="form-control" name="hospital_id" value="{{ $data->hospital_id }}" required autofocus>
                            </div>
